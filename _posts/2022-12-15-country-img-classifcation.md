...
<p align="center">
  <img src=/assets/images/img_classification/fig1.png/>
  Figure 1: The original image of a road in Aland
</p>
 
<p align="center"><img src=/assets/images/img_classification/fig2.png/></p>
<div style="text-align:center">
    <p>Figure 2: Sized down and grey-scaled image of a road in Aland, used as input into our models</p>
</div>
...
<p align="center"><img src=/assets/images/img_classification/fig5.png/></p>
<div style="text-align:center">
    <p>Figure 5: Sample count per class in the original data set, sorted by sample count; y-axis is logarithmic.</p>
</div>
...
<p align="center"><img src=/assets/images/img_classification/fig6.png/></p>
<div style="text-align:center">
    <p>Figure 6: Original image fed into the Stable Diffusion VAE: a road in Argentina.</p>
</div>

<p align="center"><img src=/assets/images/img_classification/fig7.png/></p>
<div style="text-align:center">
    <p>Figure 7: Reconstructed image from the VAE latent space.</p>
</div>
...
<p align="center"><img src=/assets/images/img_classification/fig8.png/></p>
<div style="text-align:center">
    <p>Figure 8: The confusion matrix on the testing set from the SVM trained on the 128x128 encoded images. The predicted labels are ordered from least represented to most represented in the data set.</p>
</div>
...
<p align="center"><img src=/assets/images/img_classification/fig15.png/></p>
<div style="text-align:center">
    <p>Figure 15: Graph of training (blue) and testing (orange) accuracy with respect to epochs during training of the top part of the custom VGG-16 model.</p>
</div>

<p align="center"><img src=/assets/images/img_classification/fig16.png/></p>
<div style="text-align:center">
    <p>Figure 16: Graph of training and testing accuracy with respect to epochs during fine-tuning of the custom VGG-16 model.</p>
</div>
